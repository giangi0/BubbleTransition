...
//  BubbleTransition
//
//  Created by Giovanni Bassolino on 09/05/2019.
//  Copyright © 2019 Giovanni Bassolino. All rights reserved.
//
...
open class BubbleTransition: NSObject {
    ...
    /**
     The color of the bubble. Don't touch it.
     */
        ...
        case .dismiss,.pop:
            ...
            UIView.animate(withDuration: duration, animations: {
                ...
                if !transitionContext.transitionWasCancelled {
                    returningControllerView.layer.mask = nil
